...
# Canonical branch lookup dictionary
CANONICAL_BRANCH_MAP = {
    "المعادي": "فرع المعادي",
    "المعادى": "فرع المعادي",
    "مدينة نصر": "فرع مدينة نصر",
    "التجمع": "فرع التجمع الخامس",
    "القاهرة الجديدة": "فرع التجمع الخامس",
    "المهندسين": "فرع المهندسين",
    "الجيزة": "فرع المهندسين",
    "الإسكندرية": "فرع الإسكندرية - سموحة",
    "اسكندرية": "فرع الإسكندرية - سموحة",
    "سموحة": "فرع الإسكندرية - سموحة",
    "أسيوط": "فرع أسيوط",
    "اسيوط": "فرع أسيوط",
    "المنصورة": "فرع المنصورة",
}
