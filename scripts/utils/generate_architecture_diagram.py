...
def generate_lifecycle_diagram() -> str:
  ...
  <g transform="translate(80, 50)">
    ...
    <text x="0" y="108" fill="#94A3B8" font-size="15" font-weight="400">
      6 Ingestion Feeds (L&amp;D + Client Delivery) → T-SQL &amp; Python Quality Contracts → Microsoft SQL Server DWH (15 Tables) → Kimball Galaxy Schema (6 Dims / 4 Facts) → Power BI TMDL
    </text>

    <!-- Executive Metric Chips -->
    <g transform="translate(1420, 10)">
      ...
      <rect x="180" y="0" width="165" height="54" rx="12" fill="#0F172A" stroke="#1E293B"/>
      <text x="262" y="24" text-anchor="middle" fill="#A855F7" font-size="18" font-weight="800">3,600</text>
      <text x="262" y="42" text-anchor="middle" fill="#64748B" font-size="10" font-weight="700">CLIENT TASKS / SLAS</text>

      <rect x="360" y="0" width="165" height="54" rx="12" fill="#0F172A" stroke="#1E293B"/>
      <text x="442" y="24" text-anchor="middle" fill="#10B981" font-size="18" font-weight="800">14 / 14</text>
      <text x="442" y="42" text-anchor="middle" fill="#64748B" font-size="10" font-weight="700">PYTEST CONTRACTS</text>

      <rect x="540" y="0" width="165" height="54" rx="12" fill="#0F172A" stroke="#1E293B"/>
      <text x="622" y="24" text-anchor="middle" fill="#F59E0B" font-size="18" font-weight="800">6 DIMS / 4 FACTS</text>
      <text x="622" y="42" text-anchor="middle" fill="#64748B" font-size="10" font-weight="700">KIMBALL GALAXY</text>
    </g>
  </g>
  ...
  <g transform="translate(80, 200)">
    ...
    <!-- Source 3: Software House Client Projects (NEW) -->
  ...
  <g transform="translate(555, 200)">
    ...
    <g transform="translate(25, 85)">
      <rect x="0" y="0" width="365" height="230" rx="14" fill="url(#cardInner)" stroke="#8B5CF6" stroke-width="1"/>
      <text x="15" y="28" fill="#E9D5FF" font-size="13" font-weight="800">T-SQL Staging Transformation</text>
      <text x="15" y="48" fill="#C084FC" font-size="11" font-family="monospace">00_stg_hr_audit.sql</text>
      <rect x="15" y="60" width="335" height="1" fill="#334155"/>
      <text x="15" y="85" fill="#CBD5E1" font-size="11">1. Deduplicate Retries on 5 Key Tuples</text>
      <text x="30" y="105" fill="#A855F7" font-size="11" font-weight="700">12,516 → 12,392 Staged Rows (0 Losses)</text>
      <text x="15" y="130" fill="#CBD5E1" font-size="11">2. Arabic Fuzzy Branch Normalization</text>
      <text x="30" y="150" fill="#94A3B8" font-size="11">Standardizes سموحة, المعادي, القرية الذكية</text>
      <text x="15" y="175" fill="#CBD5E1" font-size="11">3. SCD2 LEAD() Window Chaining</text>
      <text x="30" y="195" fill="#10B981" font-size="11" font-weight="700">ValidFrom ≤ ValidTo &amp; IsCurrent Flag</text>
    </g>

    <!-- Transform 2: Python Heuristic Cleaners & Harvesters -->
    <g transform="translate(25, 335)">
      <rect x="0" y="0" width="365" height="240" rx="14" fill="url(#cardInner)" stroke="#8B5CF6" stroke-width="1"/>
      <text x="15" y="28" fill="#E9D5FF" font-size="13" font-weight="800">Python Heuristic Engines</text>
      <text x="15" y="48" fill="#C084FC" font-size="11" font-family="monospace">scripts/utils/data_cleaners.py</text>
      <rect x="15" y="60" width="335" height="1" fill="#334155"/>
      <text x="15" y="85" fill="#CBD5E1" font-size="11">• Attendance Clock-Out Imputation:</text>
      <text x="28" y="105" fill="#38BDF8" font-size="11">COALESCE(CheckOut, CheckIn + 8 Hours)</text>
      <text x="15" y="130" fill="#CBD5E1" font-size="11">• Dynamic Date Range Harvesting:</text>
      <text x="28" y="150" fill="#38BDF8" font-size="11">List.Min() / List.Max() boundary sync</text>
      <text x="15" y="175" fill="#CBD5E1" font-size="11">• In-Memory Table.Buffer() Caching:</text>
      <text x="28" y="195" fill="#38BDF8" font-size="11">Pins Dim_Employee in RAM (300% boost)</text>
      <text x="15" y="220" fill="#CBD5E1" font-size="11">• FP&amp;A Wide-to-Tall CROSS APPLY</text>
    </g>
    ...
    <g transform="translate(25, 595)">
      ...
      <text x="150" y="32" fill="#6EE7B7" font-size="13" font-weight="800">14/14 Pytests Passing</text>
      <text x="15" y="60" fill="#34D399" font-size="11" font-family="monospace">tests/test_data_quality.py</text>
      <rect x="15" y="72" width="335" height="1" fill="#334155"/>
      <text x="15" y="95" fill="#CBD5E1" font-size="11">✔ Master Text Fidelity (7,000 EMP IDs)</text>
      <text x="15" y="120" fill="#CBD5E1" font-size="11">✔ 0 Orphaned FKs Across Constellation</text>
      <text x="15" y="145" fill="#CBD5E1" font-size="11">✔ SCD2 Interval Temporal Continuity</text>
      <text x="15" y="170" fill="#CBD5E1" font-size="11">✔ Attendance Duration in [0.0, 24.0] h</text>
      <text x="15" y="195" fill="#CBD5E1" font-size="11">✔ Client Hours Realization &amp; Rate Checks</text>
      <text x="15" y="220" fill="#CBD5E1" font-size="11">✔ Salary Compression &amp; Bench Ratios</text>
      <text x="15" y="245" fill="#10B981" font-size="11" font-weight="700">✔ CI/CD Test Execution: 2.16s in pytest</text>
    </g>

    <!-- Transform 4: Staging Materialization Tables -->
    <g transform="translate(25, 875)">
      <rect x="0" y="0" width="365" height="270" rx="14" fill="url(#cardInner)" stroke="#8B5CF6" stroke-width="1"/>
      <text x="15" y="28" fill="#E9D5FF" font-size="13" font-weight="800">Staging Layer Materialization</text>
      <text x="15" y="48" fill="#C084FC" font-size="11">Database Schema: [stg]</text>
      <rect x="15" y="60" width="335" height="1" fill="#334155"/>
      <text x="15" y="88" fill="#F1F5F9" font-size="11" font-weight="700">1. stg.Stg_HR_Audit (12,392 rows)</text>
      <text x="28" y="108" fill="#94A3B8" font-size="11">SCD2 valid chain, indexed on (EmpID, Date)</text>
      <text x="15" y="135" fill="#F1F5F9" font-size="11" font-weight="700">2. stg.Exit_Attrition_Records (350 rows)</text>
      <text x="28" y="155" fill="#94A3B8" font-size="11">Severance reasons, notice vs exit dates</text>
      <text x="15" y="182" fill="#F1F5F9" font-size="11" font-weight="700">3. stg.Employees_Core (7,000 rows)</text>
      <text x="28" y="202" fill="#94A3B8" font-size="11">Arabic attribute UTF-8 mapped core</text>
      <text x="15" y="230" fill="#F1F5F9" font-size="11" font-weight="700">4. stg.Client_Tasks (3,600 rows)</text>
      <text x="28" y="250" fill="#94A3B8" font-size="11">Milestone delivery tasks &amp; hourly rates</text>
    </g>
  </g>
  ...
  <g transform="translate(1030, 200)">
    ...
    <g transform="translate(25, 85)">
      ...
      <g transform="translate(20, 18)">
        <rect x="0" y="0" width="325" height="45" rx="8" fill="#042F2E" stroke="#0D9488"/>
        <text x="162" y="22" text-anchor="middle" fill="#5EEAD4" font-size="13" font-weight="800">EnterpriseHR_DWH</text>
        <text x="162" y="38" text-anchor="middle" fill="#99F6E4" font-size="10">localhost:1433 | Windows Integrated Auth</text>
      </g>

      <!-- Schema 1: raw -->
      <g transform="translate(20, 78)">
        <rect x="0" y="0" width="325" height="235" rx="10" fill="#0F172A" stroke="#334155"/>
        <rect x="15" y="10" width="70" height="20" rx="4" fill="#1E293B"/>
        <text x="50" y="24" text-anchor="middle" fill="#38BDF8" font-size="10" font-weight="800">SCHEMA: raw</text>
        ...
        <text x="15" y="98" fill="#E2E8F0" font-size="11" font-weight="700">• raw.Client_Project_Tasks</text>
        <text x="310" y="98" text-anchor="end" fill="#38BDF8" font-size="11" font-weight="700">3,600</text>
        <text x="15" y="121" fill="#E2E8F0" font-size="11" font-weight="700">• raw.LMS_Certifications</text>
        <text x="310" y="121" text-anchor="end" fill="#38BDF8" font-size="11" font-weight="700">7,197</text>
        ...
        <rect x="15" y="158" width="295" height="1" fill="#1E293B"/>
        <text x="15" y="180" fill="#10B981" font-size="10" font-weight="700">✔ Idempotent Truncate &amp; Load</text>
        <text x="15" y="198" fill="#38BDF8" font-size="10">✔ Strictly typed (no VARCHAR(MAX))</text>
        <text x="15" y="216" fill="#F59E0B" font-size="10">✔ Low Memory Grant (0 semaphore wait)</text>
      </g>

      <!-- Schema 2: stg -->
      <g transform="translate(20, 325)">
        <rect x="0" y="0" width="325" height="145" rx="10" fill="#0F172A" stroke="#334155"/>
        <rect x="15" y="10" width="70" height="20" rx="4" fill="#1E293B"/>
        <text x="50" y="24" text-anchor="middle" fill="#C084FC" font-size="10" font-weight="800">SCHEMA: stg</text>
        <text x="15" y="52" fill="#E2E8F0" font-size="11" font-weight="700">• stg.Stg_HR_Audit</text>
        <text x="310" y="52" text-anchor="end" fill="#C084FC" font-size="11" font-weight="700">12,392 rows</text>
        <text x="15" y="75" fill="#E2E8F0" font-size="11" font-weight="700">• stg.Exit_Attrition_Records</text>
        <text x="310" y="75" text-anchor="end" fill="#C084FC" font-size="11" font-weight="700">350 rows</text>
        <text x="15" y="98" fill="#E2E8F0" font-size="11" font-weight="700">• stg.Client_Tasks_Clean</text>
        <text x="310" y="98" text-anchor="end" fill="#C084FC" font-size="11" font-weight="700">3,600 rows</text>
        <rect x="15" y="112" width="295" height="1" fill="#1E293B"/>
        <text x="15" y="130" fill="#10B981" font-size="10" font-weight="700">✔ Clustered PK + Temporal IX</text>
      </g>

      <!-- Schema 3: mart -->
      <g transform="translate(20, 485)">
        <rect x="0" y="0" width="325" height="555" rx="10" fill="#0F172A" stroke="#10B981" stroke-width="1.2"/>
        <rect x="15" y="10" width="75" height="20" rx="4" fill="#065F46"/>
        <text x="52" y="24" text-anchor="middle" fill="#6EE7B7" font-size="10" font-weight="800">SCHEMA: mart</text>
        <text x="15" y="46" fill="#34D399" font-size="11" font-weight="700">CONFORMED DIMENSIONS (6)</text>
        
        <text x="15" y="70" fill="#E2E8F0" font-size="11">• mart.Dim_Employee (SCD2)</text>
        <text x="310" y="70" text-anchor="end" fill="#34D399" font-size="11">7,000</text>

        <text x="15" y="90" fill="#E2E8F0" font-size="11">• mart.Dim_Department</text>
        <text x="310" y="90" text-anchor="end" fill="#34D399" font-size="11">6</text>

        <text x="15" y="110" fill="#E2E8F0" font-size="11">• mart.Dim_Branch</text>
        <text x="310" y="110" text-anchor="end" fill="#34D399" font-size="11">14</text>

        <text x="15" y="130" fill="#E2E8F0" font-size="11">• mart.Dim_Date (Calendar)</text>
        <text x="310" y="130" text-anchor="end" fill="#34D399" font-size="11">1,096</text>

        <text x="15" y="150" fill="#E2E8F0" font-size="11">• mart.Dim_Course (L&amp;D Tiers)</text>
        <text x="310" y="150" text-anchor="end" fill="#34D399" font-size="11">10</text>

        <text x="15" y="170" fill="#E2E8F0" font-size="11">• mart.Dim_CurrencyRates (FX)</text>
        <text x="310" y="170" text-anchor="end" fill="#34D399" font-size="11">6</text>

        <rect x="15" y="185" width="295" height="1" fill="#1E293B"/>
        <text x="15" y="208" fill="#FBBF24" font-size="11" font-weight="700">GALAXY FACT CONSTELLATIONS (4+)</text>

        <text x="15" y="232" fill="#E2E8F0" font-size="11">• mart.Fact_WorkforceSnapshot</text>
        <text x="310" y="232" text-anchor="end" fill="#FBBF24" font-size="11">7,000</text>

        <text x="15" y="254" fill="#E2E8F0" font-size="11">• mart.Fact_DailyAttendance</text>
        <text x="310" y="254" text-anchor="end" fill="#FBBF24" font-size="11">16,000</text>

        <text x="15" y="276" fill="#E2E8F0" font-size="11">• mart.Fact_DepartmentBudget</text>
        <text x="310" y="276" text-anchor="end" fill="#FBBF24" font-size="11">672</text>

        <text x="15" y="298" fill="#E2E8F0" font-size="11">• mart.Fact_TrainingCompletions</text>
        <text x="310" y="298" text-anchor="end" fill="#FBBF24" font-size="11">2,735</text>

        <text x="15" y="320" fill="#E2E8F0" font-size="11">• mart.Fact_ProjectTasks (Client)</text>
        <text x="310" y="320" text-anchor="end" fill="#FBBF24" font-size="11">3,600</text>

        <text x="15" y="342" fill="#E2E8F0" font-size="11">• mart.Fact_Daily_Badge</text>
        <text x="310" y="342" text-anchor="end" fill="#FBBF24" font-size="11">114,952</text>

        <text x="15" y="364" fill="#E2E8F0" font-size="11">• mart.Fact_Employee_SCD2</text>
        <text x="310" y="364" text-anchor="end" fill="#FBBF24" font-size="11">12,392</text>

        <rect x="15" y="380" width="295" height="1" fill="#1E293B"/>
        <text x="15" y="405" fill="#F1F5F9" font-size="12" font-weight="800">DWH TOTAL: 185,708 ROWS</text>
        <text x="15" y="428" fill="#10B981" font-size="11" font-weight="700">★ 0 Referential Integrity Orphans</text>
        <text x="15" y="448" fill="#38BDF8" font-size="11">★ Fully Materialized via T-SQL &amp; Python</text>
        <text x="15" y="468" fill="#C084FC" font-size="11">★ Pipeline Runtime: &lt; 45 Seconds</text>
      </g>
    </g>
  </g>
  ...
  <g transform="translate(1505, 200)">
    ...
    <g transform="translate(25, 445)">
      ...
      <text x="15" y="28" fill="#FDE68A" font-size="13" font-weight="800">4+ Fact Constellations</text>
      <text x="15" y="48" fill="#94A3B8" font-size="11">Differing Operational Grains &amp; Cadences</text>
      <rect x="15" y="60" width="335" height="1" fill="#334155"/>

      <text x="15" y="85" fill="#FBBF24" font-size="11" font-weight="700">1. Monthly Periodic Snapshot</text>
      <text x="30" y="105" fill="#CBD5E1" font-size="11">Fact_WorkforceSnapshot (HC, Salary, Flight Risk)</text>

      <text x="15" y="130" fill="#FBBF24" font-size="11" font-weight="700">2. Daily IoT Clock-Ins</text>
      <text x="30" y="150" fill="#CBD5E1" font-size="11">Fact_DailyAttendance (Swipes, Remote Gates)</text>

      <text x="15" y="175" fill="#FBBF24" font-size="11" font-weight="700">3. Quarterly FP&amp;A Run-Rate</text>
      <text x="30" y="195" fill="#CBD5E1" font-size="11">Fact_DepartmentBudget (DAX Budget ÷ 3)</text>

      <text x="15" y="220" fill="#FBBF24" font-size="11" font-weight="700">4. Software House Delivery Milestones</text>
    </g>
    ...
    <g transform="translate(25, 695)">
      ...
      <text x="15" y="365" fill="#10B981" font-size="11" font-weight="700">✔ Eliminates Grain Mismatch &amp; Fan Traps</text>
      <text x="15" y="390" fill="#A855F7" font-size="11" font-weight="700">✔ Full Kimball Dimensional Standard</text>
      <text x="15" y="415" fill="#38BDF8" font-size="11" font-weight="700">✔ In-Memory Table.Buffer() Optimized</text>
    </g>
  </g>
...
def generate_galaxy_diagram() -> str:
    """Generates the modern Kimball Galaxy Schema (Fact Constellation) Diagram SVG with 6 Dims and 4+ Facts."""
    return '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2400 1440" width="2400" height="1440" style="background:#030712; font-family:'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <defs>
    <!-- Background Gradient -->
  ...
  <g transform="translate(80, 45)">
    <rect x="0" y="0" width="370" height="32" rx="16" fill="#064E3B" stroke="#059669" stroke-width="1.2"/>
    <circle cx="16" cy="16" r="5" fill="#34D399"/>
    <text x="32" y="21" fill="#A7F3D0" font-size="11" font-weight="800" letter-spacing="1.5">KIMBALL GALAXY SCHEMA · FACT CONSTELLATION</text>
    ...
    <text x="0" y="102" fill="#94A3B8" font-size="15">
      6 Conformed Dimensions (Green) Shared Across 4+ Analytical Fact Tables (Amber) with Single-Direction (1 → *) Filter Propagation &amp; Table.Buffer() Caching
    </text>

    <!-- Advanced Architecture Badges -->
    <g transform="translate(1520, 10)">
      <g transform="translate(0, 0)">
        <rect x="0" y="0" width="220" height="40" rx="10" fill="#0F172A" stroke="#10B981" stroke-width="1.2"/>
        <circle cx="18" cy="20" r="5" fill="#10B981"/>
        <text x="32" y="25" fill="#D1FAE5" font-size="11" font-weight="700">In-Memory Table.Buffer()</text>
      </g>

      <g transform="translate(235, 0)">
        <rect x="0" y="0" width="220" height="40" rx="10" fill="#0F172A" stroke="#0284C7" stroke-width="1.2"/>
        <circle cx="18" cy="20" r="5" fill="#38BDF8"/>
        <text x="32" y="25" fill="#E0F2FE" font-size="11" font-weight="700">Dynamic Date Harvesting</text>
      </g>

      <g transform="translate(470, 0)">
        <rect x="0" y="0" width="270" height="40" rx="10" fill="#0F172A" stroke="#F59E0B" stroke-width="1.2"/>
        <circle cx="18" cy="20" r="5" fill="#FBBF24"/>
        <text x="32" y="25" fill="#FEF3C7" font-size="11" font-weight="700">Multi-Currency (Dim_CurrencyRates)</text>
      </g>
    </g>
  </g>
  ...
  <!-- DIMENSION 6: Dim_CurrencyRates (NEW - RIGHT LOWER) -->
  ...
  <!-- ========================================================================= -->
  <!-- 4+ GALAXY FACT TABLES (AMBER/ORANGE THEME)                                 -->
  <!-- ========================================================================= -->
  ...
  <g transform="translate(60, 500)" filter="url(#shadowBox2)">
    ...
    <g transform="translate(20, 65)">
      ...
      <text x="0" y="320" fill="#10B981" font-size="11" font-weight="700">Grain: 1 Row / Active Employee / Month</text>
    </g>
  </g>
  ...
  <g transform="translate(980, 960)" filter="url(#shadowBox2)">
    ...
    <g transform="translate(20, 65)">
      ...
      <text x="0" y="270" fill="#10B981" font-size="11" font-weight="700">Grain: 1 Row / Employee / Badge Access Day</text>
    </g>
  </g>
  ...
  <g transform="translate(520, 960)" filter="url(#shadowBox2)">
    ...
    <g transform="translate(20, 65)">
      ...
      <text x="0" y="270" fill="#10B981" font-size="11" font-weight="700">Grain: 1 Row / Dept / Branch / Quarter</text>
    </g>
  </g>
  ...
  <g transform="translate(1950, 180)" filter="url(#shadowBox2)">
    ...
    <g transform="translate(20, 65)">
      ...
      <text x="0" y="295" fill="#10B981" font-size="11" font-weight="700">Grain: 1 Row / Certification Attempt</text>
    </g>
  </g>

  <!-- FACT 5: Fact_ProjectTasks (NEW - FAR RIGHT LOWER) -->
  <g transform="translate(1950, 610)" filter="url(#shadowBox2)">
    ...
    <g transform="translate(20, 65)">
      ...
      <text x="0" y="320" fill="#10B981" font-size="11" font-weight="700">Grain: 1 Row / Client Milestone Task</text>
    </g>
  </g>
  ...
  <g transform="translate(60, 1260)">
    <rect x="0" y="0" width="880" height="75" rx="14" fill="#0B1222" stroke="#1E293B"/>
    ...
    <rect x="750" y="22" width="110" height="30" rx="8" fill="#1E293B" stroke="#334155"/>
    <text x="805" y="41" text-anchor="middle" fill="#38BDF8" font-size="11" font-weight="700">VERTI-PAQ OPT</text>
  </g>
</svg>'''
